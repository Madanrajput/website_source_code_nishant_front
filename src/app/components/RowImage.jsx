...
//           <Image
//             src={props.ImgAbout || "/images/about/About-banner.jpg"}
      ...
      <div className="row mx-0">
        <div className={`col-lg-${imageColLg} col-xl-${imageColXl} col-md-${imageColMd} col-${imageCol}`}>
          <Image
            ...
            height={400}
            sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 50vw"
            // 🌟 PERF FIX: Added height: auto to prevent Layout Shifts (CLS)
            style={{ width: "100%", maxWidth: "100%", height: "auto" }}
            // 🌟 PERF FIX: Added priority props to bypass lazy loading
